<template>
    <div class="p-6">
       ...
       <label class="block mt-4 text-sm font-medium text-gray-700">Catégorie : <span class="mt-1 p-2 w-full">{{ ticket.category }}</span></label>
       ...
       <label class="block mt-4 text-sm font-medium text-gray-700">Priorité : <span class="mt-1 p-2 w-full">{{ ticket.priority }}</span></label>
